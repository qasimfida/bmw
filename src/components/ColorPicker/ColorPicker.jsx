...
const ColorPicker = ({ colors }) => {
  ...
  return (
    <div className="p-5 rounded-xl bg-bg-card/70 border border-border-subtle backdrop-blur-md">
      <div className="flex items-center justify-between mb-3">
        <div>
          <h3 className="text-xs font-semibold uppercase tracking-wider text-text-primary">Exterior Paint</h3>
          <p className="text-[0.75rem] text-text-muted">High-gloss & metallic finish</p>
        </div>
